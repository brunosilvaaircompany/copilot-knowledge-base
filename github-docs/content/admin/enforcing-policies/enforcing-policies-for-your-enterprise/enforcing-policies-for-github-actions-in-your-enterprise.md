...
## Check, workflow run, status, artifact, log, and cache settings
...
By default, checks, workflow runs, commit statuses, and the artifacts and log files generated by workflows are retained for 90 days. You can change this retention period to anywhere between 1 and 400 days.
