...
* Ensure you can authenticate to the Manage GitHub Enterprise Server API. For more information, see [Enterprise Admin](https://docs.github.com/en/rest/enterprise-admin#authentication).
