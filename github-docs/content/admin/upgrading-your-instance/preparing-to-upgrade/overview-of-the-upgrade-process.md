...
Which type you can take depends on your platform. AWS and Google Compute Engine support disk snapshots only. See [Taking A Snapshot](https://docs.github.com/en/admin/upgrading-your-instance/preparing-to-upgrade/taking-a-snapshot).
...
* Delete any VM or disk snapshots taken prior to upgrading. See [Taking A Snapshot](https://docs.github.com/en/admin/upgrading-your-instance/preparing-to-upgrade/taking-a-snapshot).
