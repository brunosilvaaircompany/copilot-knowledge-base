...
You can filter for draft pull requests. For more information, see [Pull Requests](https://docs.github.com/en/pull-requests/reference/pull-requests#draft-pull-requests).
