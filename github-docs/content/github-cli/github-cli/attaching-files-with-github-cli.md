...
The GitHub CLI only supports uploading image and media files. For a list of supported file types, see [Attaching Files](https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/attaching-files#image-and-media-files).
