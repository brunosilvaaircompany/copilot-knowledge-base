...
* The setup user for an enterprise that uses Enterprise Managed Users (see [Setup User](https://docs.github.com/en/enterprise-cloud@latest/admin/concepts/identity-and-access-management/setup-user))
