...
You can rename a branch in a repository on your GitHub Enterprise Server instance. For more information about branches, see [Branches](https://docs.github.com/en/pull-requests/reference/branches).
