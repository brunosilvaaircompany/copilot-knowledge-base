...
For information on using the `/fleet` slash command, and the `--fleet` command line option, see [Speed Up Task Completion](https://docs.github.com/en/copilot/how-tos/copilot-cli/use-copilot-cli/speed-up-task-completion).
