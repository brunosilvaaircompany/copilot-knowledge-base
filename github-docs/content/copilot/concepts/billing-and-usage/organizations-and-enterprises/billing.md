...
For a full explanation of how these controls work together and when usage gets blocked, see [Budgets](https://docs.github.com/en/copilot/concepts/billing-and-usage/organizations-and-enterprises/budgets).
