...
> [!NOTE]
> Existing customers receive higher included AI credits during the promotional period (June–August 2026). See [Usage Based Billing](https://docs.github.com/en/copilot/concepts/billing/organizations-and-enterprises/usage-based-billing#promotional-amounts-for-existing-customers).
