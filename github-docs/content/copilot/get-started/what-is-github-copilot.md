...
* The GitHub Copilot app, a desktop application for agent-driven development. See [GitHub Copilot App](https://docs.github.com/en/copilot/concepts/agents/github-copilot-app).
* The GitHub website
