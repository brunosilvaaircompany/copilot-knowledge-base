...
Pressing <kbd>Esc</kbd> twice only opens the rewind picker when Copilot is idle. For details of what a double <kbd>Esc</kbd> does when an operation is in progress, see [Cancel And Roll Back](https://docs.github.com/en/copilot/concepts/agents/copilot-cli/cancel-and-roll-back#what-pressing-esc-does-in-different-situations).
