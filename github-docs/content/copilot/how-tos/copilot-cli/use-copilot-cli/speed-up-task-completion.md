...
For more information about the `-p` option and running tasks without an interactive session, see [Run CLI Programmatically](https://docs.github.com/en/copilot/how-tos/copilot-cli/automate-copilot-cli/run-cli-programmatically).
