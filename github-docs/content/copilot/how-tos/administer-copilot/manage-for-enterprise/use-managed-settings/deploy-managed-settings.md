...
There are additional considerations if you use a dedicated enterprise for Copilot Business. See [Copilot Business Only](https://docs.github.com/en/copilot/how-tos/administer-copilot/manage-for-enterprise/use-managed-settings/copilot-business-only).
