...
See [Image Input](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/image-input) for the attachment API and the `file` and `blob` attachment shapes.
...
* [Streaming Events](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/streaming-events): subscribe to session events and narrow event types
* [Image Input](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/image-input): attach files and in-memory blobs to a message
* [Session Persistence](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/session-persistence): resume sessions and re-apply session options
* [Compatibility](https://docs.github.com/en/copilot/how-tos/copilot-sdk/troubleshooting/compatibility): SDK and CLI feature matrix
