...
> [!NOTE]
> Agent mode in Copilot Chat in IDEs does not support content exclusion. For more information, see [Chat In Ide](https://docs.github.com/en/copilot/how-tos/chat-with-copilot/chat-in-ide).
