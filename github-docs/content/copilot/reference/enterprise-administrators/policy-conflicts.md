...
Policies can be defined for a whole enterprise, or set at the organization level. See [Policies](https://docs.github.com/en/copilot/concepts/enterprise/policies).
