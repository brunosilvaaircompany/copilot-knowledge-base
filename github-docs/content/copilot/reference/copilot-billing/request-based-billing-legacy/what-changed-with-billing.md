...
* To understand more about how the new usage-based billing works, see [Billing](https://docs.github.com/en/copilot/concepts/billing-and-usage/individuals/billing).
