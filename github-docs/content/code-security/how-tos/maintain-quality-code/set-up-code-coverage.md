...
* Code Quality is enabled for your repository. See [Enable Code Quality](https://docs.github.com/en/code-security/how-tos/maintain-quality-code/enable-code-quality).
...
1. If the workflow runs successfully in CI and coverage uploads correctly, merge the pull request.
   ...
   If the workflow needs adjustments, see [Automatic Code Coverage Setup](https://docs.github.com/en/code-security/concepts/code-quality/automatic-code-coverage-setup) for guidance on the different outcomes and how to iterate.

For more information about how the agent works and what to expect, see [Automatic Code Coverage Setup](https://docs.github.com/en/code-security/concepts/code-quality/automatic-code-coverage-setup).
