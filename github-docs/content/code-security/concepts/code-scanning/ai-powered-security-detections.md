...
For a full list of languages supported by CodeQL, see [Codeql Code Scanning](https://docs.github.com/en/code-security/concepts/code-scanning/codeql/codeql-code-scanning).
...
* **Organization**: The **AI Scan** setting under "Code scanning" enables AI Scan for eligible repositories in the organization where code scanning is enabled. See [Configure Global Settings](https://docs.github.com/en/code-security/how-tos/secure-at-scale/configure-organization-security/establish-complete-coverage/configure-global-settings#enabling-ai-scan).
...
You can use the REST API to manage the organization or repository `ai-scan` setting. See [Code Scanning](https://docs.github.com/en/rest/code-scanning/code-scanning#get-the-ai-scan-setting-for-an-organization).
