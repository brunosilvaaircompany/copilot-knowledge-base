...
Each REST API endpoint is documented individually, and the endpoints are categorized by the resource that they primarily affect. For example, you can find endpoints relating to issues in [Issues](https://docs.github.com/en/rest/issues).
...
For a list of libraries to facilitate scripting with the REST API, see [Libraries For The Rest API](https://docs.github.com/en/rest/using-the-rest-api/libraries-for-the-rest-api).
