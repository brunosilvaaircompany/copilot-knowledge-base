...
* Stack metadata is available in workflow expressions via `github.event.pull_request.stack`, if you want to customize workflow behavior specifically for stacked pull requests. Since a workflow runs once per pull request in a stack, teams can use this metadata to limit expensive jobs and reduce CI usage. For details, see [Optimizing Ci For Stacked Pull Requests](https://docs.github.com/en/pull-requests/how-tos/merge-and-close-pull-requests/optimizing-ci-for-stacked-pull-requests).
...
To create their first stack, direct people to [Stacked Prs Quickstart](https://docs.github.com/en/pull-requests/get-started/stacked-prs-quickstart). After the pilot, gather feedback from developers and reviewers on:
...
After the pilot, share day-to-day guidance on creating, reviewing, managing, and merging stacks with teams: [Stacked Pull Requests](https://docs.github.com/en/pull-requests/how-tos/stacked-pull-requests).
...
Teams producing a high volume of AI-generated code, one of the fit signals from step 1, can find guidance on stacking changes from coding agents in [Stack Ai Generated Code In Pull Requests](https://docs.github.com/en/copilot/tutorials/stack-ai-generated-code-in-pull-requests).
