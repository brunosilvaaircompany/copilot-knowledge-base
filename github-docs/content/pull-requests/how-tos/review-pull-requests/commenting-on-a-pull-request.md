...
1. When you're done:
   ...
   * If you only want to add this **one comment**, click **Comment**{% elsif ghes %}**Add single comment**.

   * If you want to add **multiple comments**, click **Start a review**, then continue adding comments.

     When you're finished, click **Submit review**{% elsif ghes %}**Finish your review**, leave a summary of your review, and click **Submit review**.
