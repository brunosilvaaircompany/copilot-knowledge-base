...
**IMPORTANT:** Your organization might have disabled the use of hooks in VS Code. Contact your admin for more information. See [enterprise policies](https://code.visualstudio.com/docs/enterprise/policies) for details.
...
* [Security considerations](../agents/run/security.md) - Best practices for AI security in VS Code
