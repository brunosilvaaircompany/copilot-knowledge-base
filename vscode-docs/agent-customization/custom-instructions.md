...
**NOTE:** {% data variables.product.prodname_vscode_shortname %} also supports the use of an [`AGENTS.md` file](#use-an-agentsmd-file) for always-on instructions.
...
{% data variables.product.prodname_vscode_shortname %} can sync your user instructions files across multiple devices by using [Settings Sync](https://code.visualstudio.com/docs/configure/settings-sync).
...
**TIP:** Use the chat customization diagnostics view to see all loaded instruction files and any errors. In the {% data variables.copilot.chat_view %}, open the context menu and select **Diagnostics**. Learn more about [checking customization diagnostics](../agents/agent-troubleshooting/troubleshooting.md#check-customization-diagnostics).
