...
**NOTE:** Light and dark color themes have separate backgrounds and image layouts. These choices are stored on the current machine and don't sync across devices.
