...
**NOTE:** Unless otherwise noted, the features on this page work in both the [{% data variables.copilot.chat_view %}](../agents/run/chat-view.md) and the [{% data variables.copilot.agents_window %}](../agents/run/agents-window.md).
...
For tool names and context references, see the [Tools and context reference](../agents/reference/tools-reference.md).
...
You can attach multiple items. The attachments are preserved in a draft and included when you send the request. Learn more about [starting an agent session in the {% data variables.copilot.agents_window %}](../agents/run/agents-window.md#start-an-agent-session).
...
Use the [integrated browser](https://code.visualstudio.com/docs/debugtest/integrated-browser) to preview web pages and attach information from the current page to a prompt.
...
Learn how to [add browser context to chat](https://code.visualstudio.com/docs/debugtest/integrated-browser#add-context-to-ai-chat). To let an agent interact with a page instead of attaching it as prompt context, see [browser tools for agents](https://code.visualstudio.com/docs/debugtest/integrated-browser#browser-tools-for-agents).
...
* [Debug chat interactions](../agents/agent-troubleshooting/chat-debug-view.md)
* [Diagnose prompt caching with the Cache Explorer](../agents/agent-troubleshooting/cache-explorer.md)
