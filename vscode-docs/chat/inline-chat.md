...
**NOTE:** This feature is experimental and works with the `setting(inlineChat.renderMode)` setting set to `hover`.

## Use terminal inline chat

You can bring up terminal inline chat in the [integrated terminal](https://code.visualstudio.com/docs/terminal/basics) to get help with shell commands or ask terminal-related questions.
