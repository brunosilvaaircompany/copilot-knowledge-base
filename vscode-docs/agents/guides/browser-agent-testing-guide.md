...
This guide walks you through that loop by building and validating a calculator app. For browser tool capabilities, session types, privacy controls, and prompting patterns, see [Use browser tools with agents](../run/browser-tools.md).
...
* [A GitHub Copilot subscription](https://code.visualstudio.com/docs/setup/copilot)
...
* [Use browser tools with agents](../run/browser-tools.md)
* [Integrated browser](https://code.visualstudio.com/docs/debugtest/integrated-browser)
* [Core concepts of AI in {% data variables.product.prodname_vscode_shortname %}](../concepts/agents.md)
