...
Use [terminal inline chat](../../chat/inline-chat.md#use-terminal-inline-chat) to get help with shell commands and terminal operations.
...
Learn more about [best practices for crafting prompts](../best-practices.md) and [adding context to your prompts](../../chat/copilot-chat-context.md).

## Related resources

* [Chat overview](../../chat/chat-overview.md)
* [Add context to your chat prompt](../../chat/copilot-chat-context.md)
* [Inline chat](../../chat/inline-chat.md)
