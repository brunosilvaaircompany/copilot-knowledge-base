...
**TIP:** For an interactive view of the cache metrics without setting up an OTel backend, use the [Cache Explorer](../agent-troubleshooting/cache-explorer.md) to inspect prompt cache hit rates directly in VS Code.
...
* [Troubleshoot AI in VS Code](../agent-troubleshooting/troubleshooting.md)
