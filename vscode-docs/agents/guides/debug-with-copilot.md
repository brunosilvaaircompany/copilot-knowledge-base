...
{% data variables.product.prodname_vscode_shortname %} uses the `launch.json` file to store [debug configuration](https://code.visualstudio.com/docs/debugtest/debugging-configuration). Copilot can help you create and customize this file to set up debugging for your project.
...
Learn more about [debugging in {% data variables.product.prodname_vscode_shortname %}](https://code.visualstudio.com/docs/debugtest/debugging).
...
Learn more about using [Copilot Chat](../../chat/chat-overview.md) in {% data variables.product.prodname_vscode_shortname %}.
...
* Explore [general debugging features in {% data variables.product.prodname_vscode_shortname %}](https://code.visualstudio.com/docs/debugtest/debugging).
* Learn more about [Copilot in {% data variables.product.prodname_vscode_shortname %}](https://code.visualstudio.com/docs/agent-native/overview).
