...
If you are new to {% data variables.product.prodname_vscode_shortname %} or AI, you might want to review the [AI in {% data variables.product.prodname_vscode_shortname %} Overview](https://code.visualstudio.com/docs/agent-native/overview) article first or dive straight into the [Getting started](../agents-tutorial.md) tutorial.
...
Learn more about [using context in chat](../../chat/copilot-chat-context.md).
