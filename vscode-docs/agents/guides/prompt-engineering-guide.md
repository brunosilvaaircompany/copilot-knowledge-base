...
If you are new to VS Code or AI, you might want to review the [AI in VS Code Overview](https://code.visualstudio.com/docs/agent-native/overview) article first or dive straight into the [Getting started](../agents-tutorial.md) tutorial.
