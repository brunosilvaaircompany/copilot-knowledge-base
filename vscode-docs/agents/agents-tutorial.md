...
* [Start the VS Code editing tutorial](https://code.visualstudio.com/docs/editing/getting-started)
...
**TIP:** If you don't have a Copilot subscription yet, you can use Copilot for free by signing up for the [Copilot Free plan](https://github.com/github-copilot/signup) and get a monthly allowance of inline suggestions and AI credits.
...
* [Learn about the Agents window](run/agents-window.md)
...
* [Learn about the Chat view](run/chat-view.md)
...
* [Learn more about the Agents window](run/agents-window.md)

* [Learn more about the Chat view](run/chat-view.md)
