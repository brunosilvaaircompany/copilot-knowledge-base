...
* [Start the {% data variables.product.prodname_vscode_shortname %} editing tutorial](https://code.visualstudio.com/docs/editing/getting-started/editor-tutorial)
...
**TIP:** If you don't have a Copilot subscription yet, you can use Copilot for free by signing up for the [{% data variables.copilot.copilot_free_short %} plan](https://github.com/github-copilot/signup) and get a monthly allowance of inline suggestions and AI credits.
...
* [Learn about the {% data variables.copilot.agents_window %}](run/agents-window.md)
...
1. Select **Folder**, and then select the `myportfolio` folder on your machine. This folder becomes the primary execution workspace for the session.
    ...
    > [!IMPORTANT]
    > Workspace Trust lets you decide whether code in your project folder can be executed. When you download code from the internet, you should first review it to make sure it's safe to run. Get more info about [Workspace Trust](https://code.visualstudio.com/docs/editing/workspaces/workspace-trust).
...
1. Select the **Copilot** agent harness to run your agent session locally on your machine using the {% data variables.copilot.copilot_sdk %}.
    ...
    {% data variables.product.prodname_vscode_shortname %} supports multiple [agent harnesses](concepts/agent-harnesses.md), such as Claude and Codex. The harness coordinates the model, tools, and session in the selected execution environment.
...
* [Learn about the {% data variables.copilot.chat_view %}](run/chat-view.md)
...
* [Start customization tutorial](guides/customize-copilot-guide.md)
...
* [Learn more about the {% data variables.copilot.agents_window %}](run/agents-window.md)

* [Learn more about the {% data variables.copilot.chat_view %}](run/chat-view.md)
