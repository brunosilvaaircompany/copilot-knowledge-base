...
* **Work remotely**: if you're connected to a [remote workspace](https://code.visualstudio.com/docs/remote/remote-overview), agents in the Chat view work there too, with access to the same context and tools as you have.

In this article, you learn how to open and work with agents in the Chat view. For chat mechanics that apply to both the Chat view and the [Agents window](agents-window.md) — such as sending requests, adding context, and reviewing changes — see [Use chat in VS Code](../../chat/chat-overview.md).
...
**TIP:** The Chat view (code-first) and the [Agents window](agents-window.md) (agent-first) are the main surfaces for working with agents. They share the same sessions and settings, so you can move freely between them. To switch, select the **Open in Agents** button in the title bar, or run `code --agents`. For help choosing, see [Choose how you work with agents](../overview.md#choose-how-you-work-with-agents).
...
* Run `code chat` from the command line to start chat from outside VS Code. Learn more about [starting chat from the command line](https://code.visualstudio.com/docs/configure/command-line#start-chat-from-the-command-line).
...
**TIP:** You can open chat in an editor tab, a separate window, or maximized for more space. Learn more about the [Chat view layout options](#layout-options).
...
* [Use the Agents window](agents-window.md) - work with agents across multiple projects.
