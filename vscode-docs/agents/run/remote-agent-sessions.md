...
The browser-based {% data variables.copilot.agents_window %} connects to your development machine through a [dev tunnel](https://code.visualstudio.com/docs/remote/tunnels). Agent sessions run on the remote host, and the browser acts as a lightweight client for chatting, reviewing changes, and managing sessions.
...
* [Use the {% data variables.copilot.agents_window %}](agents-window.md) - agent-first workflows across multiple projects.
