...
The [Agents window](agents-window.md) lets you connect to remote machines to start agent sessions or check in on existing ones. You can connect over SSH, through a dev tunnel, or use the Agents window directly in a browser from any device.
...
**Prerequisite**: a dev tunnel is already running on the remote machine. See [Developing with Remote Tunnels](https://code.visualstudio.com/docs/remote/tunnels) for setup instructions.
...
The browser-based Agents window connects to your development machine through a [dev tunnel](https://code.visualstudio.com/docs/remote/tunnels). Agent sessions run on the remote host, and the browser acts as a lightweight client for chatting, reviewing changes, and managing sessions.
...
* [Use the Agents window](agents-window.md) - agent-first workflows across multiple projects.
* [Choose an agent harness](agent-harnesses.md) - compare harnesses, execution environments, and isolation options.
* [Developing with Remote Tunnels](https://code.visualstudio.com/docs/remote/tunnels) - set up and manage dev tunnels.
* [Security](security.md) - trust boundaries and security considerations.
