...
**NOTE:** You can review AI-generated changes in both the [Chat view](chat-view.md) and the [Agents window](agents-window.md). The review experience follows the same concepts, but the user interface differs between the two surfaces.
...
**IMPORTANT:** If you automatically accept all edits, review the changes before you commit them in source control. Learn more about the [security considerations of using AI in VS Code](security.md).
