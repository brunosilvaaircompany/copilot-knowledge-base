...
When you enable the [experimental single-pane editor panel](agents-window.md#use-the-single-pane-editor-panel-experimental), the **Changes** view and diff editor share one docked pane.
