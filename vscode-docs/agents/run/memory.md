...
For background on how memory fits into the agent architecture, see [Agents concepts](../concepts/agents.md#memory).
...
* [Planning with agents](planning.md)
