...
* [Browser agent testing guide](guides/browser-agent-testing-guide.md)
...
* [AI features enabled in {% data variables.product.prodname_vscode_shortname %}](https://code.visualstudio.com/docs/getstarted/overview#enable-ai-features)
...
* Learn how to [choose an agent harness](run/agent-harnesses.md)
* [Plan and research tasks with the Plan agent](run/planning.md)
* Explore [creating custom agents](../agent-customization/custom-agents.md)
