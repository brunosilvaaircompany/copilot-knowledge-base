...
* **Keep instructions stable**: Changing instructions files or custom agent definitions mid-session breaks the cache. For more information, see the [context engineering guide](../guides/context-engineering-guide.md).
...
* **Isolate exploration in subagents**: Run research in a [subagent](../run/subagents.md) to keep the parent session prompt stable.
...
* [OpenTelemetry monitoring for agents](../guides/monitoring-agents.md)
