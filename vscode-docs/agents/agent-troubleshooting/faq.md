...
* Configure a [bring-your-own-key model](../../agent-customization/language-models.md#bring-your-own-language-model-key) for supported chat features without GitHub sign-in.
...
If you don't want to use AI, you can continue using {% data variables.product.prodname_vscode_shortname %} without signing in. To hide the built-in AI features, see [Remove AI features from {% data variables.product.prodname_vscode_shortname %}](https://code.visualstudio.com/docs/setup/copilot#remove-ai-features-from-vs-code).
...
To identify a failing connection, [collect network diagnostics](troubleshooting.md#collect-network-diagnostics).
...
If these checks pass, [view the GitHub Copilot logs](troubleshooting.md#view-logs-for-github-copilot).
...
If these checks pass, follow the [symptom-based troubleshooting steps](troubleshooting.md#choose-a-troubleshooting-path).
...
Yes. Organization administrators can manage Copilot through [enterprise AI settings](https://code.visualstudio.com/docs/enterprise/ai-settings) and [policies](https://code.visualstudio.com/docs/enterprise/policies), including enabling or disabling agents, controlling model access, configuring content exclusions, and enforcing trust boundaries. See the [GitHub Copilot Trust Center](https://resources.github.com/copilot-trust-center/) for compliance details.
...
You can choose which models are available in the language model picker. Learn how to [customize the language model picker](../../agent-customization/language-models.md#customize-the-model-picker).
...
See [Report an unresolved issue](troubleshooting.md#report-an-unresolved-issue) for the reporting steps, evidence checklist, and precautions for sharing diagnostic data. Follow the [Copilot issue-reporting guidelines](https://github.com/microsoft/vscode/wiki/Copilot-Issues) to make the report actionable.
