...
If an agent is responding but follows the wrong approach, repeats an unsuccessful action, or changes more than expected, see [Get an agent back on track](../guides/get-agent-back-on-track.md).
...
For more information about network configuration, see [Network and firewall configuration for Copilot](faq.md#network-and-firewall-configuration-for-copilot).
...
* **Agent Debug Log panel (Preview):**
    ...
    Learn more about the [Agent Debug Log panel](chat-debug-view.md#agent-debug-log-panel).
...
* **Cache Explorer:**
    ...
    Learn more about the [Cache Explorer](cache-explorer.md).
...
Learn more about the [Chat Debug view](chat-debug-view.md#chat-debug-view).
...
Learn more about [configuring and debugging MCP servers](../../agent-customization/mcp-servers.md).
...
* [Diagnose prompt caching with the Cache Explorer](cache-explorer.md)
* [Custom instructions](../../agent-customization/custom-instructions.md)
* [MCP servers](../../agent-customization/mcp-servers.md)
* [GitHub Copilot FAQ](faq.md)
