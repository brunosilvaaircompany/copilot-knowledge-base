...
* **Checkpoint and roll back**: return a session to an earlier point to undo a set of changes. Learn more about [checkpoints](../run/review-code-edits.md#edit-requests-and-restore-checkpoints).
