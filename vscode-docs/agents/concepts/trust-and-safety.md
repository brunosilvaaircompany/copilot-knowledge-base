...
* **Review before applying.** All file changes surface in a diff view for keep/undo decisions, and [checkpoints](../run/review-code-edits.md#edit-requests-and-restore-checkpoints) let you roll back a session.
