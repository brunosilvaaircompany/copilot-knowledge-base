...
**NOTE:** Agent sandboxing is currently in preview and might further evolve.
...
* [Terminal sandbox configuration](../run/approvals.md#sandbox-agent-commands)
* [Reviewing code edits](../run/review-code-edits.md)
* [Checkpoints](../run/review-code-edits.md#edit-requests-and-restore-checkpoints)
* [Tool approval](../run/approvals.md#tool-approval)
