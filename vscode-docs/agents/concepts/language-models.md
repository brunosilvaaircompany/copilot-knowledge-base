...
Language models don't execute code or access files directly. Instead, they generate text that the [agent loop](agents.md#agent-loop) interprets as actions. When a model requests a tool call, VS Code executes the tool and feeds the result back to the model for the next iteration.
...
Learn more about [how VS Code assembles context](context.md) and [context compaction](../run/sessions/manage-sessions.md#compact-conversation-context).
...
Learn how to [configure the thinking effort level](../../agent-customization/language-models.md#configure-thinking-effort) in VS Code.
...
Learn how to [choose and configure language models](../../agent-customization/language-models.md) in VS Code.
...
Learn how to [add your own language model key](../../agent-customization/language-models.md#bring-your-own-language-model-key) in VS Code.
