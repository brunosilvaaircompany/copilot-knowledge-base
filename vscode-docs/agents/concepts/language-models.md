...
* **Context-dependent**: the quality of the response depends on the quality and relevance of the [context](context.md) provided in the prompt.
...
Learn more about [how {% data variables.product.prodname_vscode_shortname %} assembles context](context.md) and [context compaction](../run/sessions/manage-sessions.md#compact-conversation-context).
...
Learn how to [configure the thinking effort level](../../agent-customization/language-models.md#configure-thinking-effort) in {% data variables.product.prodname_vscode_shortname %}.
...
Other factors also affect credit consumption, such as [thinking effort](../../agent-customization/language-models.md#configure-thinking-effort) (higher effort produces more thinking tokens), context window size, and tool usage. Prompt caching lowers the effective cost of a request by reusing tokens from a previous one. You can inspect cache hit rates with the [Cache Explorer](../agent-troubleshooting/cache-explorer.md). For practical tips on reducing credit consumption, see [optimize AI credit usage](../guides/optimize-usage.md).

Learn how to [choose and configure language models](../../agent-customization/language-models.md) in {% data variables.product.prodname_vscode_shortname %}.
...
Learn how to [add your own language model key](../../agent-customization/language-models.md#bring-your-own-language-model-key) in {% data variables.product.prodname_vscode_shortname %}.
